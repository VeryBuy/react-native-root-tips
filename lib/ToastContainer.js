...
const DEVICE_WIDTH = Math.min(DIMENSION.width, WEB_MAX_WIDTH);
const WINDOW_WIDTH = Platform.OS === 'web' ?  DEVICE_WIDTH : DIMENSION.width;
        ...
        <Mask mask={props.mask} maskColor={props.maskColor} maskOpacity={props.maskOpacity}>
            ...
            >
                ...
                >
                    ...
                    {
                      props.customComponent ? props.customComponent() : null
                    }
